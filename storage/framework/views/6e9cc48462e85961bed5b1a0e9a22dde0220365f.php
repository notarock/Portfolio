	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 centered">
				<img src="assets/img/user.png" alt="Photo de profile">
...
<?php echo $__env->make("projets.listes", ['lstProjets' => $lstProjets ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
